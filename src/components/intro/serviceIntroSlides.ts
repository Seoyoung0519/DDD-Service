...
export type ServiceIntroSlide = {
  ...
  /** 목업 이미지 리사이즈 모드 */
  mockupResizeMode?: 'cover' | 'contain';
  /** contain 모드일 때 화면 너비 대비 이미지 너비 비율 (0~1) */
  mockupWidthRatio?: number;
  /** contain 모드일 때 화면 높이 대비 이미지 최대 높이 비율 (0~1) */
  mockupMaxHeightRatio?: number;
};
...
export const SERVICE_INTRO_SLIDES: ServiceIntroSlide[] = [
  {
    ...
    mockupBottomInset: 0,
    mockupResizeMode: 'contain',
    mockupWidthRatio: 0.75,
    mockupMaxHeightRatio: 0.7,
  },
  {
    id: 'book-progress',
